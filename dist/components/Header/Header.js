...
import { selectedDay as selectedDayState, targetMonth as targetMonthState, targetYear as targetYearState, isMonthSelectorHidden as isMonthSelectorHiddenState, isViewSelectorHidden as isViewSelectorHiddenState, calendarView as calendarViewSelector, clientTimezoneSelector, enableTimezoneAtom } from "@root/Recoil/calendar.atom";
...
export default function Header() {
  ...
  const [isMonthSelectorHidden, setIsMonthSelectorHidden] = useRecoilState(isMonthSelectorHiddenState);
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: `flex flex-row flex-nowrap justify-between w-full bg-white z-30 ${calendarView === 'LIST' ? 'sticky top-0' : ''}`
    ...
    className: ""
  }, monthArray[targetMonth - 1], " ", targetYear), /*#__PURE__*/React.createElement("div", {
    className: "ml-3"
  }, /*#__PURE__*/React.createElement("svg", {
  ...
  }))), /*#__PURE__*/React.createElement(MonthSelector, null))), /*#__PURE__*/React.createElement("div", {
    className: `flex-row flex-nowrap items-center ml-4 hidden ${enableTimezone && enableTimezone !== 'auto' ? 'md:flex md:w-5/12' : ''}`
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: `flex-row flex-nowrap items-center ml-4 hidden ${enableTimezone === 'auto' ? 'md:flex md:w-5/12' : ''}`
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-row flex-nowrap items-center text-xs"
  }, "Time zone: "), /*#__PURE__*/React.createElement("div", {
    className: `mx-4 w-full max-w-xxs text-xs text-gray-600 `
  }, clientTimezone)), /*#__PURE__*/React.createElement("div", {
  ...
  }))), /*#__PURE__*/React.createElement(ViewSelector, null)));
}
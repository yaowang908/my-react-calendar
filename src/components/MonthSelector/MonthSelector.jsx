...
export default function MonthSelector() {
    ...
    const clickHandler = (event) => {
        ...
        // console.log('MonthSelector click', event.target.dataset)
    ...
    return (
        <div
            ...
            } -ml-24 md:ml-0 absolute top-10 w-60 bg-white shadow-md z-50 text-sm p-4 box-border border text-gray-800`}
        >
            <div className="w-full h-4 flex flex-nowrap justify-between content-center">
                <div
                ...
                <div className="grid place-items-center">{targetYear}</div>
                <div
                    className="w-4 h-4 md:w-5 md:h-5 text-gray-600 hover:bg-blue-400 hover:text-white cursor-pointer grid place-items-center"
                    data-type="next_year"
                    onClick={clickHandler}
            ...
            <div className="w-full h-44 grid grid-cols-4 grid-row-3 mt-2 box-border border-t-2 border-gray-400">
